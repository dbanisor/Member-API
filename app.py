...
# ---------------------------setting authentication values to the API---------------------------#

api_username = 'admin'
api_password = '123'

# ----------------------------------------------------------------------------------------------#
# -----------------------setting a decorator to use to protect all routes-----------------------#
def protected(f):
    @wraps(f)
...
@app.teardown_appcontext # the teardown decorator: after the request is finished it makes sure the db is closed
def close_db(error):
...
def get_members():
    ...
    #---------------------------returning a list of dictionairies---------------------------#
...
@protected
def add_member():
    new_member_data = request.get_json() # this retrieves the json data passed into Postman when added a new member
    ...
    #-------------------------returning data to user in JSON---------------------------#
...
def edit_member(member_id):
    ...
    #-------------------------returning the updated data to user in JSON---------------------------#
